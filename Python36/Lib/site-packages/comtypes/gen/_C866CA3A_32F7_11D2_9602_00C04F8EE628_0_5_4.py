...
__all__ = [
    'SPSHORTCUTPAIRLIST', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPEAudioTimeOffset', 'ISpPhoneticAlphabetConverter',
    'SPBO_NONE', 'ISpeechWaveFormatEx', 'SAFT48kHz16BitMono',
    'ISpRecognizer', 'SpNullPhoneConverter', 'eLEXTYPE_PRIVATE4',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SGRsFindRule',
    'SGPronounciation', 'DISPID_SpeechLexiconWords',
    'DISPID_SPEDisplayText', 'eLEXTYPE_PRIVATE11', 'DISPID_SLPsItem',
    'DISPID_SVSpeak', 'DISPID_SBSFormat', 'SAFTCCITT_uLaw_8kHzStereo',
    'SP_VISEME_1', 'SVP_21', 'DISPID_SOTs_NewEnum',
    'SpeechCategoryVoices', 'DISPID_SVEAudioLevel',
    'SpeechPropertyLowConfidenceThreshold', 'SASPause', 'SPAS_CLOSED',
    'DISPID_SRGReset', 'DISPID_SREmulateRecognition',
    'eLEXTYPE_RESERVED4', '_RemotableHandle', 'SPRULESTATE',
    'ISpObjectToken', 'eLEXTYPE_USER_SHORTCUT', 'SAFT16kHz8BitMono',
    'DISPID_SPARecoResult', 'SPAUDIOSTATUS', 'DISPID_SOTCategory',
    'SPAR_Low', 'DISPID_SVEVoiceChange', 'DISPID_SPIStartTime',
    'ISpeechPhraseRule', 'DISPID_SpeechAudioFormat', 'SPLEXICONTYPE',
    'ISpRecognizer2', 'SREInterference', 'DISPID_SGRSTRule',
    'DISPID_SRRTStreamTime', 'SAFT48kHz16BitStereo',
    'SPEI_RECOGNITION', 'DISPID_SPIAudioSizeBytes',
    'SPPS_NotOverriden', 'DISPID_SPEs_NewEnum',
    'DISPID_SpeechLexicon', 'eLEXTYPE_PRIVATE12',
    'ISpeechRecognizerStatus', 'DISPID_SRGState', 'SECFIgnoreWidth',
    'SPDKL_DefaultLocation', 'DISPID_SRGCommit',
    'ISpeechPhraseProperty', 'SPEI_INTERFERENCE', 'SDKLCurrentConfig',
    'eLEXTYPE_PRIVATE18', 'Speech_StreamPos_Asap',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SLPPartOfSpeech',
    'SPEVENT', 'SP_VISEME_11', 'SAFT8kHz16BitMono',
    'DISPID_SDKSetBinaryValue', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SGRSTsCount',
    'DISPID_SVGetAudioInputs', 'SPBO_PAUSE', 'SPCS_DISABLED',
    'SpMMAudioIn', 'SVSFPurgeBeforeSpeak', 'DISPID_SRSAudioStatus',
    '__MIDL_IWinTypes_0009', 'ISpRecoGrammar',
    'DISPID_SRSClsidEngine', 'DISPID_SRGSetWordSequenceData',
    'SVSFNLPSpeakPunc', 'SASStop', 'DISPID_SRGRules',
    'eLEXTYPE_PRIVATE1', 'SpeechEmulationCompareFlags',
    'ISpStreamFormat', 'DISPID_SBSSeek', 'DISPID_SMSGetData',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SWFESamplesPerSec',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVSInputWordPosition',
    'SECFIgnoreCase', 'DISPID_SPCIdToPhone',
    'DISPID_SVSInputWordLength', 'SAFTNoAssignedFormat',
    'SAFTADPCM_8kHzStereo', 'ISpProperties', 'SPSHORTCUTTYPE',
    'ISpeechGrammarRules', 'ISpeechGrammarRuleState', 'SP_VISEME_15',
    'DISPID_SpeechBaseStream', 'DISPID_SRCESoundEnd',
    'DISPID_SRCEAdaptation', 'SpeechAllElements',
    'SRSInactiveWithPurge', 'DISPID_SPIReplacements',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SGRsDynamic', 'SpeechStreamSeekPositionType',
    'SSFMCreate', 'DISPID_SPISaveToMemory', 'SRTReSent',
    'SPEI_SR_RETAINEDAUDIO', 'SpTextSelectionInformation',
    'eLEXTYPE_PRIVATE6', 'SITooSlow', 'SAFT8kHz16BitStereo',
    'SGRSTTTextBuffer', 'SPPS_Noncontent', 'DISPID_SDKGetlongValue',
    'DISPID_SRRTTickCount', 'SpLexicon', 'SPSMF_SAPI_PROPERTIES',
    'ISpNotifySource', 'SDKLLocalMachine', 'SpeechTokenKeyUI',
    'SPGRAMMARWORDTYPE', 'DISPID_SABIBufferSize',
    'SpeechPropertyComplexResponseSpeed', 'SAFT16kHz8BitStereo',
    'DISPID_SRCEPropertyStringChange', 'SPFM_OPEN_READWRITE',
    'ISpSerializeState', 'DISPID_SPCPhoneToId', 'SREStreamStart',
    'SPEI_VISEME', 'SpeechAudioVolume', 'SpeechAudioFormatGUIDWave',
    'DISPIDSPTSI_SelectionOffset', 'SpeechRecoProfileProperties',
    'DISPID_SRIsUISupported', 'SPRST_ACTIVE', 'SRTSMLTimeout',
    'DISPID_SVEEnginePrivate', 'ISpeechObjectToken',
    'DISPID_SVSInputSentencePosition', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRRTimes', 'DISPID_SVSLastResult', 'DISPID_SBSWrite',
    'DISPID_SAStatus',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RESERVED6', 'SINoSignal', 'SPVOICESTATUS',
    'eLEXTYPE_PRIVATE7', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SPPId',
    'SPPHRASEELEMENT', 'SRTStandard', 'SAFT16kHz16BitMono',
    'DISPID_SVSInputSentenceLength', 'SPEVENTSOURCEINFO', 'SPWORD',
    'DISPID_SGRName', 'SPSHT_OTHER', 'DISPID_SPIEnginePrivateData',
    'DISPID_SASState', 'SPEI_SOUND_END', 'DISPID_SLWPronunciations',
    'eLEXTYPE_PRIVATE10', 'SP_VISEME_2', 'SPWT_DISPLAY', 'SPSMF_UPS',
    'SFTSREngine', 'SPCS_ENABLED', 'DISPID_SRCEEnginePrivate',
    'DISPID_SGRSAddRuleTransition', 'eLEXTYPE_RESERVED6',
    'SpObjectToken', 'DISPID_SLPLangId', 'DISPID_SGRsItem',
    'ISpeechLexiconWords', 'DISPID_SRRTLength', 'DISPID_SLWLangId',
    'ISpeechXMLRecoResult', 'ISpeechAudioFormat',
    'SpeechVoicePriority', 'SPSERIALIZEDRESULT',
    'SpeechTokenValueCLSID', 'DISPID_SOTCDefault',
    'DISPID_SOTMatchesAttributes', 'DISPID_SAFType',
    'DISPID_SRCEStartStream', 'SVSFlagsAsync', 'SpPhoneConverter',
    'DISPID_SpeechLexiconPronunciation', 'SPPS_RESERVED2',
    'DISPID_SPPParent', 'DISPID_SLGetGenerationChange',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SGRAttributes',
    'SRSInactive', 'Speech_Max_Word_Length', 'IEnumSpObjectTokens',
    'ISpShortcut', 'DISPID_SGRAddState', 'ISpeechPhraseInfoBuilder',
    'DISPID_SGRClear', 'SPAO_NONE', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVSkip', 'SGSExclusive', '_SPAUDIOSTATE', 'DISPID_SVRate',
    'SPADAPTATIONRELEVANCE', 'SAFT12kHz16BitMono',
    'SpObjectTokenCategory', 'ISpeechPhraseReplacement',
    'SVEEndInputStream', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRCEEndStream', 'SVP_19', 'SDKLCurrentUser',
    'SPPS_SuppressWord', 'SPPHRASERULE', 'DISPID_SFSOpen',
    'SPCT_SUB_COMMAND', 'ISpRecoContext2',
    'DISPID_SpeechRecoContextEvents', 'Speech_StreamPos_RealTime',
    'ISpXMLRecoResult', 'DISPID_SPRDisplayAttributes', 'SVPOver',
    'SPCATEGORYTYPE', 'ISpAudio', 'DISPID_SPAsCount',
    'DISPID_SAFGuid', 'DISPID_SGRsCount', 'SPSInterjection',
    'SRTAutopause', 'STSF_FlagCreate', 'SVF_None',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SWFEChannels',
    'SSTTTextBuffer', 'ISpeechRecoResultDispatch',
    'SAFTGSM610_8kHzMono', 'SPXRO_SML', 'SPEI_RESERVED3',
    'DISPID_SOTIsUISupported', 'DISPID_SPRNumberOfElements', 'SVP_5',
    'SAFT16kHz16BitStereo', 'DISPID_SPIRule', 'SECFEmulateResult',
    'SpeechVisemeType', 'DISPID_SpeechAudio', 'DISPID_SABIEventBias',
    'DISPID_SOTCGetDataKey', 'tagSTATSTG', 'SVP_7',
    'SGDSActiveUserDelimited', 'SITooFast', 'SP_VISEME_4',
    'SRERecoOtherContext', 'ISpVoice', 'ISpEventSink',
    'SPSHT_NotOverriden', 'SAFT12kHz8BitStereo', 'SPVPRIORITY',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRCEInterference',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpeechPhraseAlternates', 'DISPID_SPEActualConfidence',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPERequiredConfidence', 'SpeechDataKeyLocation',
    'DISPID_SRState', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SWFEExtraData', 'STCRemoteServer', 'DISPID_SRProfile',
    'ISpNotifySink', 'SpeechCategoryAudioOut',
    'ISpeechPhoneConverter', 'SRSEDone', 'DISPID_SPRFirstElement',
    'SBONone', 'SPWORDLIST', 'SGSDisabled', 'SPBO_TIME_UNITS',
    'SDTPronunciation', 'DISPID_SOTSetId', 'SPSLMA',
    'DISPID_SPPFirstElement', 'SVP_14', 'DISPID_SRAudioInputStream',
    'DISPID_SRGRecoContext', 'DISPID_SRRecognizer',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTDataKey',
    'SpeechLexiconType', 'DISPID_SOTRemoveStorageFileName',
    'STCLocalServer', 'ISpMMSysAudio', 'DISPID_SVPriority',
    'SPEI_RESERVED2', 'DISPID_SPRuleChildren',
    'DISPID_SRSetPropertyString', 'DISPID_SRStatus',
    'DISPID_SPRulesItem', 'SAFT22kHz8BitStereo',
    'SPINTERFERENCE_NOISE', 'SP_VISEME_0', 'SpResourceManager',
    'SPSHORTCUTPAIR', 'DISPID_SASNonBlockingIO', 'eLEXTYPE_PRIVATE13',
    'SVEAudioLevel', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SVP_17', 'SAFTADPCM_11kHzStereo', 'STCInprocServer',
    'DISPID_SRCERecognizerStateChange', 'ISpRecognizer3',
    'DISPID_SOTsItem', 'SAFT22kHz8BitMono', 'SECFDefault',
    'SpNotifyTranslator', 'SECHighConfidence', 'SPPS_Noun',
    'DISPID_SVSLastBookmark', 'SAFT11kHz16BitMono',
    'DISPID_SWFEBlockAlign', 'SVP_20',
    'DISPID_SRSNumberOfActiveRules', 'SDTProperty', 'DISPID_SLWsItem',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechFileStream',
    'SVP_1', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SpeechObjectTokens', 'SPRST_INACTIVE', 'DISPID_SAVolume',
    'SP_VISEME_7', 'SWPUnknownWordPronounceable',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechRecoResult',
    'DISPID_SPRuleId', 'DISPIDSPTSI_SelectionLength',
    'SAFTADPCM_44kHzStereo', 'DISPID_SDKSetLongValue',
    'SPPS_RESERVED1', 'DISPID_SWFEFormatTag', 'SAFTText',
    'SVSFParseMask', 'eLEXTYPE_RESERVED9', 'SPPS_Unknown',
    'SpeechVoiceCategoryTTSRate', 'ISpeechRecoContext',
    'DISPID_SpeechVoiceEvent', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRSRule',
    'ISpeechTextSelectionInformation', 'DISPIDSPTSI_ActiveLength',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpVoice', 'DISPID_SMSADeviceId',
    'DISPIDSPRG', 'SP_VISEME_14', 'SAFT32kHz8BitStereo',
    'SPEI_REQUEST_UI', 'DISPID_SPPNumberOfElements',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpeechGrammarRule',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGIsPronounceable',
    'SpeechGrammarTagWildcard', 'DISPID_SPIEngineId',
    'SPEI_RESERVED5', 'SpeechLoadOption', 'STCInprocHandler',
    'SpeechVoiceEvents', 'ISpGrammarBuilder', 'SPINTERFERENCE',
    'DISPID_SPEPronunciation', 'SPDKL_LocalMachine',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRGetFormat',
    'DISPID_SVGetAudioOutputs', 'SPBO_AHEAD',
    'DISPID_SVSLastStreamNumberQueued', 'SPAS_STOP', 'SpCustomStream',
    'SRADefaultToActive', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPPConfidence', 'SPSModifier',
    'DISPID_SpeechRecoResult2', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRCESoundStart', 'DISPID_SVVolume', 'DISPID_SPPsCount',
    'SpPhoneticAlphabetConverter', 'SPFILEMODE',
    'DISPID_SLWs_NewEnum', 'SpeechStreamFileMode',
    'SPRECOCONTEXTSTATUS', 'SPVPRI_NORMAL', 'DISPID_SpeechDataKey',
    'DISPID_SRCVoice', 'eLEXTYPE_RESERVED7', 'SP_VISEME_5',
    'IEnumString', 'DISPID_SDKGetBinaryValue', 'SP_VISEME_8',
    'eWORDTYPE_ADDED', 'SPEI_SR_BOOKMARK', 'SPPS_Interjection',
    'ISpeechAudioStatus', 'SpeechRetainedAudioOptions',
    'SGRSTTEpsilon', 'SREStreamEnd', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPCLangId', 'DISPID_SpeechPhraseReplacement',
    'SDA_One_Trailing_Space', 'DISPID_SpeechRecognizer',
    'SpeechGrammarWordType', 'DISPID_SPEsItem',
    'DISPID_SPEAudioSizeBytes', 'SBOPause', 'SP_VISEME_10',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPEAudioSizeTime',
    'DISPID_SDKOpenKey', 'ISpRecoContext', 'SVEStartInputStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPRuleParent',
    'DISPID_SRRAudioFormat', 'DISPID_SVEBookmark', 'SASClosed',
    'SpeechRecognizerState',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechObjectTokenCategory', 'SVSFParseSsml',
    'DISPID_SGRSTPropertyName', 'SPPARTOFSPEECH',
    'SAFT12kHz16BitStereo', 'SAFT44kHz16BitMono', 'SREHypothesis',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPEAudioStreamOffset',
    'ISpeechGrammarRuleStateTransitions', 'SECLowConfidence',
    'DISPID_SLPSymbolic', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPIGrammarId',
    'SVF_Emphasis', 'DISPID_SRCEventInterests',
    'DISPID_SRCRetainedAudio', 'SpeechTokenIdUserLexicon',
    'DISPID_SRCState', 'IInternetSecurityManager',
    'DISPID_SDKDeleteValue', 'SAFTADPCM_22kHzMono', 'SRESoundEnd',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRGCmdSetRuleState', 'SPWORDPRONOUNCEABLE',
    'SSFMOpenForRead', 'ISpEventSource', 'SRTExtendableParse',
    'DISPID_SPIProperties', '_ISpeechVoiceEvents',
    'SAFTCCITT_uLaw_11kHzMono', 'SFTInput', 'DISPID_SOTsCount',
    'SPEI_MAX_TTS', 'SREAllEvents', 'DISPID_SMSSetData',
    'SPPS_Modifier', 'DISPID_SBSRead', 'SVEViseme', 'SINone',
    'DISPID_SRSetPropertyNumber', 'ISpeechResourceLoader',
    'ISpDataKey', 'SPWF_SRENGINE', 'DISPID_SRGetPropertyString',
    'SPAO_RETAIN_AUDIO', 'SPSTREAMFORMATTYPE', 'SPSHT_EMAIL',
    'SPPS_Verb', 'DISPID_SRRSpeakAudio', 'SPEI_WORD_BOUNDARY',
    'DISPID_SGRSTText', 'SVPNormal', 'SGSEnabled',
    'DISPID_SRCreateRecoContext', 'SpeechBookmarkOptions', 'SRARoot',
    'SpeechCategoryAppLexicons', 'SPFM_CREATE',
    'SDA_No_Trailing_Space', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPACommit', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRCBookmark', 'eLEXTYPE_PRIVATE8',
    'DISPID_SPRuleConfidence', 'SPEI_SOUND_START',
    'SpPhraseInfoBuilder', 'SRAInterpreter', 'SRATopLevel',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SABIMinNotification',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPELexicalForm', 'tagSPPROPERTYINFO',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechTokenKeyAttributes',
    'SVEVoiceChange', 'DISPID_SpeechWaveFormatEx', 'SPAS_PAUSE',
    'SpeechAudioState', 'SpeechRuleState', 'SVP_10',
    'DISPID_SFSClose', 'DISPID_SPEEngineConfidence', 'SLODynamic',
    'SPXMLRESULTOPTIONS', 'SpSharedRecoContext', 'SPEI_MAX_SR',
    'SREPropertyNumChange', 'SRAORetainAudio', 'ISpeechPhraseInfo',
    'DISPID_SpeechObjectToken', 'SPSERIALIZEDPHRASE',
    'DISPID_SGRSTPropertyValue', 'SpFileStream',
    'DISPID_SPIRetainedSizeBytes', 'SAFTADPCM_11kHzMono',
    'SGDSActiveWithAutoPause', 'SECNormalConfidence',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPEsCount', 'DISPID_SLGetWords', 'SpeechTokenContext',
    'SP_VISEME_12', 'SDTDisplayText', 'SVSFIsFilename',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPTEXTSELECTIONINFO',
    'SpAudioFormat', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SVEViseme', 'SpeechEngineProperties',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPIAudioSizeTime',
    'SGDisplay', 'SDTAudio', 'SVP_0', 'SpeechAudioFormatGUIDText',
    'SVP_6', 'DISPID_SPIAudioStreamPosition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVP_11',
    'ISpRecoResult', 'DISPID_SLGenerationId', 'SPBINARYGRAMMAR',
    'ISpeechBaseStream', 'DISPID_SGRSTransitions',
    'DISPID_SpeechCustomStream', 'SP_VISEME_21', 'DISPID_SMSALineId',
    'DISPID_SVSRunningState', 'SAFTGSM610_11kHzMono',
    'DISPID_SRCEPhraseStart', 'SVSFVoiceMask',
    'SpeechPropertyResourceUsage', 'SSSPTRelativeToCurrentPosition',
    'SAFT32kHz8BitMono', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SLWType',
    'DISPID_SCSBaseStream', 'SPEI_START_SR_STREAM', 'SpMemoryStream',
    'DISPID_SRGDictationUnload',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpRecoGrammar2',
    'SPPROPERTYINFO', 'SAFT12kHz8BitMono', 'SpInProcRecoContext',
    'ISpeechPhraseElement', 'SAFTGSM610_44kHzMono',
    'ISpeechObjectTokens', 'SPEI_END_INPUT_STREAM', 'SPSUnknown',
    'ISpeechPhraseElements', 'SVP_12',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'eLEXTYPE_PRIVATE16', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRGId', 'SPDKL_CurrentUser', 'ISpObjectWithToken',
    'DISPID_SpeechMemoryStream', 'SPWORDTYPE', 'SpeechRecoEvents',
    'ISpeechVoice', 'ISpPhoneConverter', 'SLTUser',
    'ISpeechAudioBufferInfo', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_APP', 'DISPID_SVStatus', 'DISPID_SRGCmdLoadFromMemory',
    'SDKLDefaultLocation', 'DISPID_SVSpeakStream', 'SpMMAudioEnum',
    'ISpeechMMSysAudio', 'ISpPhrase', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SABufferInfo', 'SSSPTRelativeToStart',
    'DISPID_SVSyncronousSpeakTimeout', 'SpSharedRecognizer',
    'DISPID_SVPause', 'ISpLexicon', 'DISPID_SASetState',
    'DISPID_SOTCSetId', 'DISPID_SRCERecognition',
    'DISPID_SPPEngineConfidence', 'SPLOADOPTIONS', 'DISPIDSPTSI',
    'SAFTADPCM_22kHzStereo', 'SP_VISEME_18', 'SpeechCategoryAudioIn',
    'SpeechWordPronounceable', 'SPXRO_Alternates_SML', 'SP_VISEME_20',
    'DISPID_SRCCmdMaxAlternates',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVPAlert',
    'DISPID_SRRSaveToMemory', 'SP_VISEME_17', 'DISPID_SRAudioInput',
    'SAFT44kHz8BitStereo', 'DISPID_SRRPhraseInfo',
    'ISpResourceManager', 'DISPID_SVSVisemeId', 'DISPID_SPRs_NewEnum',
    'IStream', 'SGDSActive', 'SITooLoud', 'SSFMCreateForWrite',
    'SPWORDPRONUNCIATIONLIST', 'SpeechRunState', 'SPWF_INPUT',
    'ISpPhraseAlt', 'SAFT48kHz8BitStereo', 'DISPID_SpeechPhraseInfo',
    'DISPID_SGRSTNextState', 'SGRSTTWildcard', 'SRSActive', 'SINoise',
    'DISPID_SRGetRecognizers', 'SpCompressedLexicon',
    'DISPID_SRGDictationSetState', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFT44kHz16BitStereo', 'SVEBookmark', 'DISPID_SOTDisplayUI',
    'DISPID_SRCPause', 'ISpeechLexiconWord', 'SGLexical', 'SPVISEMES',
    'SpeechAudioProperties', 'SDTRule', 'SVP_9', 'DISPID_SPIElements',
    'SPWT_PRONUNCIATION', 'SPVPRI_ALERT', 'ISpRecoCategory',
    'DISPID_SRCSetAdaptationData', 'SAFT11kHz8BitStereo',
    'SSTTDictation', 'SPEI_PHONEME', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SLPPhoneIds', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechRegistryLocalMachineRoot', 'SVP_18', 'SPLO_DYNAMIC',
    'DISPID_SGRsAdd', 'SWPKnownWordPronounceable', 'DISPID_SPRsItem',
    'SPRECOGNIZERSTATUS', 'DISPID_SVIsUISupported',
    'DISPID_SpeechVoice', 'ISpeechFileStream', 'SAFT24kHz16BitMono',
    'SREAudioLevel', 'DISPID_SpeechMMSysAudio',
    'ISpeechPhraseAlternate', 'eLEXTYPE_RESERVED10', 'SVP_2',
    'SRADynamic', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SGRSTPropertyId', 'SpeechGrammarRuleStateTransitionType',
    'SITooQuiet', 'DISPID_SGRAddResource', 'SPWORDPRONUNCIATION',
    'SWPUnknownWordUnpronounceable', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_PRIVATE5', 'DISPID_SGRsCommitAndSave', 'SPPS_LMA',
    'SPFM_OPEN_READONLY', 'SWTAdded', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVP_13', 'DISPID_SpeechPhraseElements', 'DISPID_SLPType',
    'DISPID_SPAStartElementInResult', 'SPPHRASE',
    'DISPID_SRCEAudioLevel', 'DISPID_SOTGetAttribute',
    'DISPID_SVGetVoices', 'eLEXTYPE_PRIVATE15',
    'SpeechRuleAttributes', 'SAFTNonStandardFormat',
    'SpeechGrammarTagUnlimitedDictation', 'SVP_8', 'SpWaveFormatEx',
    'SAFT24kHz8BitMono', 'SpeechAddRemoveWord',
    'DISPID_SPRules_NewEnum', 'SP_VISEME_16', 'DISPID_SGRs_NewEnum',
    'DISPID_SADefaultFormat', 'SPINTERFERENCE_TOOFAST',
    'SpeechFormatType', 'DISPIDSPTSI_ActiveOffset', 'SVP_16',
    'DISPID_SRCEBookmark', 'ISequentialStream',
    'DISPID_SpeechPhraseReplacements', 'SpStreamFormatConverter',
    'SAFT8kHz8BitMono', 'SpeechDiscardType', 'DISPID_SVResume',
    'SREPropertyStringChange', 'SPEI_TTS_PRIVATE',
    'SPBOOKMARKOPTIONS', 'SRSActiveAlways', 'DISPID_SGRSTWeight',
    'SPLO_STATIC', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRCEFalseRecognition', 'SPEI_VOICE_CHANGE',
    'ISpPhoneticAlphabetSelection', 'SpeechSpecialTransitionType',
    'DISPID_SRIsShared', 'DISPID_SVAudioOutput', 'SPEI_END_SR_STREAM',
    'ISpStream', 'DISPID_SpeechGrammarRule',
    'DISPID_SGRSAddSpecialTransition', 'SpUnCompressedLexicon',
    'SPCT_DICTATION', 'SAFTGSM610_22kHzMono', 'SPGRAMMARSTATE',
    'Speech_Max_Pron_Length', 'SPPHRASEREPLACEMENT',
    'DISPID_SLPs_NewEnum', 'DISPID_SVEStreamEnd',
    'SpeechGrammarState', 'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_13',
    'SPINTERFERENCE_NONE', 'DISPID_SAEventHandle', 'DISPID_SLWsCount',
    'SDTAll', 'DISPID_SPILanguageId', 'SpeechDictationTopicSpelling',
    'SVP_15', 'SVP_4', 'SVSFIsNotXML', 'SPEI_UNDEFINED',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechRecoResultTimes', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SLWWord', '_ISpeechRecoContextEvents', 'SVSFNLPMask',
    'SPSHT_Unknown', 'SAFT22kHz16BitStereo', 'SPDATAKEYLOCATION',
    'SPRECORESULTTIMES', 'SPSFunction', 'DISPID_SPRText',
    'DISPID_SVSLastBookmarkId', 'SRERequestUI', 'SREPrivate',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT48kHz8BitMono', 'eLEXTYPE_PRIVATE20',
    'DISPID_SLRemovePronunciation', 'DISPID_SVAlertBoundary',
    'SPSNoun', 'DISPID_SpeechGrammarRules', 'SPWAVEFORMATTYPE',
    'STCAll', 'SREBookmark', 'SPDKL_CurrentConfig',
    'DISPID_SRCRequestedUIType', 'eLEXTYPE_PRIVATE2', 'SPAR_High',
    'SVSFIsXML', 'eLEXTYPE_PRIVATE14', 'SDA_Two_Trailing_Spaces',
    'SpeechAudioFormatType', 'SP_VISEME_19', 'ISpeechAudio',
    'STSF_LocalAppData', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SGRId', 'DISPID_SRCRecognizer', 'SVSFUnusedFlags',
    'SPPHRASEPROPERTY', 'DISPID_SpeechPhraseRules',
    'DISPID_SPIGetDisplayAttributes', 'SPRECOSTATE',
    'SpeechCategoryRecognizers', 'SpeechRegistryUserRoot',
    'SP_VISEME_9', 'DISPID_SRGSetTextSelection',
    'SVSFParseAutodetect', 'UINT_PTR', 'ISpeechCustomStream',
    'SPFM_CREATE_ALWAYS', 'SRSEIsSpeaking', 'SAFT22kHz16BitMono',
    'STSF_AppData', 'DISPID_SAFSetWaveFormatEx', 'SRAImport',
    'SPRS_INACTIVE', 'DISPID_SPIGetText', 'SPPS_RESERVED4',
    'DISPID_SRCResume', 'SpeechCategoryPhoneConverters',
    'SPEI_TTS_BOOKMARK', 'SPEI_TTS_AUDIO_LEVEL', 'SPAUDIOOPTIONS',
    'ISpeechPhraseReplacements', 'DISPID_SDKCreateKey',
    'SPWT_LEXICAL', 'DISPID_SASCurrentDevicePosition', 'SPCT_COMMAND',
    'SVEWordBoundary', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechVoiceStatus', 'SAFTCCITT_uLaw_44kHzMono',
    'SPCT_SUB_DICTATION', 'SVF_Stressed',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechPhraseElement',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT44kHz8BitMono',
    'DISPID_SOTRemove', 'SpeechRecognitionType',
    'eLEXTYPE_VENDORLEXICON', 'SpeechWordType',
    'DISPID_SRRRecoContext', 'DISPID_SLPsCount',
    'DISPID_SpeechAudioBufferInfo', 'SSTTWildcard',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SpeechRecoContext',
    'SDTReplacement', 'DISPID_SRSSupportedLanguages',
    'DISPID_SGRSTs_NewEnum', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SREStateChange', 'ISpeechRecognizer', 'SREPhraseStart',
    'SPPS_Function', 'SPEI_HYPOTHESIS', 'SPGS_DISABLED',
    'DISPID_SPPChildren', 'SpInprocRecognizer', 'SpeechMicTraining',
    'SPVPRI_OVER', 'SPAR_Unknown', 'SpeechInterference',
    'eLEXTYPE_USER', 'SPAUDIOSTATE', 'DISPID_SPRsCount',
    'SRERecognition', 'SAFT24kHz16BitStereo', 'SPAUDIOBUFFERINFO',
    'ISpeechPhraseProperties', 'DISPID_SPPs_NewEnum', 'SRAONone',
    'DISPID_SPAPhraseInfo', 'SVESentenceBoundary',
    'SpeechTokenShellFolder', 'DISPID_SDKDeleteKey', 'SAFTDefault',
    'DISPID_SPAs_NewEnum', 'SpeechVisemeFeature', 'SVEAllEvents',
    'SAFT11kHz8BitMono', 'SGRSTTWord', 'DISPID_SPRuleFirstElement',
    'DISPID_SGRsCommit', 'DISPID_SPRulesCount', 'DISPID_SVVoice',
    'ISpStreamFormatConverter', 'ISpeechLexicon',
    'DISPID_SOTGetStorageFileName', 'DISPID_SOTGetDescription',
    'SpeechPropertyResponseSpeed', 'SRESoundStart',
    'SECFNoSpecialChars', 'SPFM_NUM_MODES', 'SGLexicalNoSpecialChars',
    'SPEI_MIN_SR', 'ISpeechGrammarRuleStateTransition',
    'SpMMAudioOut', 'ISpeechMemoryStream',
    'DISPID_SLGetPronunciations', 'SpeechUserTraining',
    'SDTAlternates', 'ISpeechVoiceStatus', 'SPCONTEXTSTATE',
    'SPSVerb', 'DISPID_SMSAMMHandle', 'SLOStatic',
    'SpeechTokenKeyFiles', 'DISPID_SOTId',
    'DISPID_SRRGetXMLErrorInfo', 'SPSEMANTICFORMAT',
    'ISpeechRecoResult', 'SREFalseRecognition',
    'DISPID_SVGetProfiles', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SDKGetStringValue', 'Speech_Default_Weight',
    'SRCS_Disabled', 'DISPID_SRCCreateGrammar', 'SDTLexicalForm',
    'SpeechPartOfSpeech', 'DISPID_SPAsItem', 'SAFT32kHz16BitStereo',
    'DISPID_SDKSetStringValue', 'SAFTExtendedAudioFormat',
    'ISpNotifyTranslator', 'SAFTCCITT_ALaw_8kHzMono', 'SPRS_ACTIVE',
    'DISPID_SRDisplayUI', 'SAFTADPCM_44kHzMono',
    'SpeechEngineConfidence', 'SWTDeleted',
    'DISPID_SVAudioOutputStream', 'SpeechDisplayAttributes',
    'SPRST_NUM_STATES', 'SVEPhoneme', 'SP_VISEME_3',
    'SAFTCCITT_uLaw_22kHzMono', 'SPGS_ENABLED',
    'DISPID_SDKEnumValues', 'SPEI_START_INPUT_STREAM',
    'ISpeechPhraseRules', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechGrammarRuleStateTransition', 'SGRSTTDictation',
    'eWORDTYPE_DELETED', 'WAVEFORMATEX', 'SRAExport', 'SREAdaptation',
    'SPEI_RECO_STATE_CHANGE', 'SPEI_ADAPTATION',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVSPhonemeId',
    'DISPID_SRGetPropertyNumber', 'SAFTADPCM_8kHzMono',
    'ISpObjectTokenCategory', 'LONG_PTR', 'SGRSTTRule',
    'DISPID_SRRAudio', 'SPRULE', 'DISPID_SRCERequestUI',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechPhraseRule',
    'DISPID_SDKEnumKeys', 'DISPID_SGRInitialState', 'SRTEmulated',
    'SP_VISEME_6', 'SPAS_RUN', 'DISPID_SGRSAddWordTransition',
    'DISPID_SOTCreateInstance', 'DISPID_SVWaitUntilDone',
    'SpShortcut', 'SAFT32kHz16BitMono', 'SPCT_SLEEP',
    'IInternetSecurityMgrSite', 'DISPID_SVEPhoneme',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpeechDataKey', 'SGDSInactive',
    'SpeechVoiceSpeakFlags', 'DISPID_SRRTOffsetFromStart',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechRecognizerStatus',
    'SPEI_SR_PRIVATE', 'SASRun', 'SSSPTRelativeToEnd', 'SpStream',
    'DISPID_SRGDictationLoad', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_PHRASE_START', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SpeechPhraseProperties', 'SPAR_Medium', 'SPEVENTENUM',
    'SPPS_RESERVED3', 'SPSSuppressWord', 'SpeechRecoContextState',
    'SLTApp', 'SVP_3', 'DISPID_SPPValue', 'SVSFDefault',
    'SPSNotOverriden', 'SAFT8kHz8BitStereo', 'eLEXTYPE_RESERVED8',
    'DISPID_SGRSTsItem', 'STSF_CommonAppData',
    'DISPID_SRCERecognitionForOtherContext', 'SPSEMANTICERRORINFO',
    'DISPID_SVEWord', 'DISPID_SPPName', 'SPEI_RESERVED1',
    'SSFMOpenReadWrite', 'SpeechGrammarTagDictation',
    'ISpeechRecoResult2', 'DISPID_SpeechLexiconProns',
    'DISPID_SRCEHypothesis', 'SVSFParseSapi', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRRGetXMLResult', 'DISPID_SGRSTType', 'SRCS_Enabled',
    'DISPID_SRCEPropertyNumberChange', 'SpeechCategoryRecoProfiles',
    'SPRST_ACTIVE_ALWAYS', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPGS_EXCLUSIVE', 'SPEI_MIN_TTS', 'DISPID_SVDisplayUI',
    'SAFT24kHz8BitStereo', 'SECFIgnoreKanaType', 'ISpeechRecoGrammar',
    'DISPID_SpeechLexiconWord', 'DISPID_SWFEBitsPerSample',
    'DISPID_SVEStreamStart', 'SVEPrivate',
    'SpeechPropertyAdaptationOn', 'DISPID_SVEventInterests',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRAlternates',
    'ISpeechLexiconPronunciations', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPPsItem', 'SVSFPersistXML', 'DISPID_SPRuleName',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SOTCId',
    'ISpeechRecoResultTimes'
]

_check_version('1.2.0', 1636700639.563896)
